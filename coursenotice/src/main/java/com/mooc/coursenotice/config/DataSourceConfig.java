package com.mooc.coursenotice.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.mooc.coursenotice.mapper";
    static final String MAPPER_LOCATION = "classpath:mapper/*.xml";
    static final String ALIAS = "com.mooc.coursenotice.model";
